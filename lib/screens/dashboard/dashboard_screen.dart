  ...
  Widget build(BuildContext context) {
    final cards = <DashboardCardData>[
      ...
      DashboardCardData(
        ...
        colors: const [Color(0xffF97316), Color(0xffFDBA74)],
        onTap: () => _open(context, MockTestListScreen()),
      ),
      DashboardCardData(
        title: 'Questions',
        count: '0',
      ...
      DashboardCardData(
        ...
        colors: const [Color(0xff0891B2), Color(0xff67E8F9)],
        onTap: () => _open(context, const ContinueLearningScreen()),
      ),
      DashboardCardData(
        title: 'Achievements',
        count: '0',
        icon: Icons.emoji_events_rounded,
        colors: const [Color(0xffD97706), Color(0xffFCD34D)],
    ...
    return Scaffold(
      ...
      drawer: Drawer(
        child: ListView(
          children: [
            const DrawerHeader(
              decoration: BoxDecoration(color: Color(0xff3730A3)),
              child: Center(
                child: Text(
                  'ARank India Admin',
      ...
      child: InkWell(
        ...
        child: Ink(
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: data.colors.first.withOpacity(.25),
                blurRadius: 18,
          ...
          child: Stack(
            children: [
              ...
              Positioned(
                right: 20,
                bottom: 18,
                child: Icon(data.icon, size: 72, color: Colors.white.withOpacity(.18)),
              ),
              Padding(
                padding: const EdgeInsets.all(24),
                child: Column(
